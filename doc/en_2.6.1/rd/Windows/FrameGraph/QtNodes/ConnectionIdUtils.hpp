...
inline QJsonObject toJson(ConnectionId const &connId)
{
    ...
    connJson[QString::fromLocal8Bit("outNodeId")] = static_cast<qint64>(connId.outNodeId);
    connJson[QString::fromLocal8Bit("outPortIndex")] = static_cast<qint64>(connId.outPortIndex);
    connJson[QString::fromLocal8Bit("intNodeId")] = static_cast<qint64>(connId.inNodeId);
    connJson[QString::fromLocal8Bit("inPortIndex")] = static_cast<qint64>(connId.inPortIndex);
...
{
    ConnectionId connId{static_cast<NodeId>(connJson[QString::fromLocal8Bit("outNodeId")].toInt(InvalidNodeId)),
                        static_cast<PortIndex>(connJson[QString::fromLocal8Bit("outPortIndex")].toInt(InvalidPortIndex)),
                        static_cast<NodeId>(connJson[QString::fromLocal8Bit("intNodeId")].toInt(InvalidNodeId)),
      static_cast<PortIndex>(connJson[QString::fromLocal8Bit("inPortIndex")].toInt(InvalidPortIndex))};
